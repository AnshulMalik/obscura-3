  ...
  <?php include_once('nav_after_login.php'); ?>
    ...
    <div class="container-fluid body">
      <div class="parallax-container levels-container valign-wrapper">
            ...
            <div class="row center">
              ...
              <div class="level-content col s12">
                <div class="level-image-container">
                  <img class="level-image" src="/levely/stairs.jpg" usemap="#Map" />
                </div>
              </div> 
        ...
        <map name="Map" id="Map">
              <area alt="" title="" href="#" shape="poly" coords="334,88,335,124,367,122,365,89" />
    ...
    $('#Map').on('click', function(e) {
      e.preventDefault();
      document.location.pathname = "level8_zozozo";
    });
    </script>
    <?php
