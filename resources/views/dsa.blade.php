<html>
  ...
  <?php include_once('nav_after_login.php'); ?>
            ...
            <div class="row center">
              ...
              <div class="level-content col s12">
                <div class="level-image-container">
                  <img class="level-image" src="/levelx/dsa.jpg" usemap="#Map" />
                </div>
              </div> 
               ...
               <form method="post" action="/checkAnswer"> 
                ...
                <div class="row">
                  ...
                  <input type="hidden" value="22" name="presentId">
                    <input type="text" class="validate answer-box" id="answer" placeholder="Answer" name="answder">
    ...
    $('#Map').on('click', function(e) {
      e.preventDefault();
      document.location.pathname = "divfinal";
    });
